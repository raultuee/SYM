...
export function Pacientes() {
    ...
    function SubHeaderPacientes() {
        return (
        <>
          <h1 className="text-black dark:text-white font-bold text-3xl pb-2">Pacientes</h1>
          ...
          <Breadcrumb className="pb-4">
                ...
                <BreadcrumbSeparator>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbLink href="/alimentos">Pacientes</BreadcrumbLink>
                    </BreadcrumbItem>
